...
* DONE Ploopy Trackball Mouse                              :ploopy:@tutorial:
:PROPERTIES:
:EXPORT_FILE_NAME: index
:EXPORT_HUGO_BUNDLE: ploopy
:EXPORT_DATE: <2026-08-18 Tue>
:EXPORT_HUGO_PUBLISHDATE:
:EXPORT_HUGO_EXPIRYDATE:
:EXPORT_AUTHOR: zhi
:EXPORT_HUGO_WEIGHT: auto
...
** What is Ploopy?
[[https://ploopy.co/][Ploopy]] is a company located in Canada that makes open-source mouse
with 3D printing material. They're especially known for
creating trackball mouses with modern sensors.
Ploopy devices use [[https://qmk.fm/][QMK]] firmware by default, this
gives you a lot of flexibility to customize your mouse.

-----

** Ploopy Classic Trackball
Ploopy [[https://ploopy.co/classic-2-trackball/][Classic]] is their most iconic model,
...
** QMK Setup
We need to first set up QMK by simply following their [[https://docs.qmk.fm/newbs_getting_started][documentation]].
...
To do this, simply go to their [[https://github.com/qmk/qmk_firmware][GitHub]] and create a fork,
